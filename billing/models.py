...
class Restaurant(models.Model):
    ...
    # used in URL paths (optional SEO)
    slug = models.SlugField(unique=True)

    # used for tenant identification (IMPORTANT)
...
class OrderItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        if self.menu.restaurant != self.order.restaurant:
            raise ValueError("Item belongs to different restaurant")
